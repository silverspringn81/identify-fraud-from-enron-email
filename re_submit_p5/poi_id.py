...
# Tuning without PCA
'''
pipeline = Pipeline([('scaler' , MinMaxScaler()), ('gnb', GaussianNB())])
parameters = {} 
'''
...
# Tuning with PCA
#pipeline = Pipeline([('scaler' , MinMaxScaler()), ('reduce_dim', RandomizedPCA()), ('dct', DecisionTreeClassifier())])
#parameters = {'reduce_dim__n_components': (2,3,4), 'dct__min_samples_split': (2,3,5)}


# Tuning without PCA
pipeline = Pipeline([('scaler' , MinMaxScaler()), ('dct', DecisionTreeClassifier())])
...
# Tuning with PCA
#pipeline = Pipeline([('scaler' , MinMaxScaler()), ('reduce_dim', RandomizedPCA()), ('svm', SVC())])
#parameters = {'reduce_dim__n_components': (2,3,4), 
#              'svm__C': (10, 100, 1000),
...
# This line should be commented out when exploring outliers or selecting features
clf = GridSearchCV(pipeline, parameters, verbose=0, n_jobs=-1, scoring='f1')
